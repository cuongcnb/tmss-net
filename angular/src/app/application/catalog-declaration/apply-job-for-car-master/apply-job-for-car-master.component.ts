...
@Component({
  ...
  selector: 'apply-job-for-car-master',
  templateUrl: './apply-job-for-car-master.component.html',
  styleUrls: ['./apply-job-for-car-master.component.scss']
})
export class ApplyJobForCarMasterComponent implements OnInit {
  ...
  constructor(
    ...
    this.fieldGridJob = [
      ...
      {
        headerName: 'Định mức giờ công',
        headerTooltip: 'ĐM GC',
        field: 'jobtime',
        cellClass: ['cell-border', 'cell-readonly', 'text-right'],
      },
      {
        headerName: 'Giờ công thực tế',
        headerTooltip: 'GC TT',
        field: 'actualJobTime',
        cellClass: ['cell-border', 'cell-readonly', 'text-right'],
      },
