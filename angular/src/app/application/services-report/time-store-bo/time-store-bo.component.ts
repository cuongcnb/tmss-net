...
@Component({
  ...
  selector: 'time-store-bo',
  templateUrl: './time-store-bo.component.html',
  styleUrls: ['./time-store-bo.component.scss']
})
export class TimeStoreBoComponent extends AppComponentBase implements OnInit {
  ...
  downloadFile() {
    ...
    this.loadingService.setDisplay(true);
    this.serviceReportApi.timeStoreBo(obj).subscribe(res => {
