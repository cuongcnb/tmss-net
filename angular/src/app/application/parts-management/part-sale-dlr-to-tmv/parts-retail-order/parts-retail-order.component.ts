...
@Component({
  ...
  selector: 'parts-retail-order',
  templateUrl: './parts-retail-order.component.html',
  styleUrls: ['./parts-retail-order.component.scss']
})
export class PartsRetailOrderComponent implements OnInit {
