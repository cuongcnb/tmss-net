...
@Component({
  ...
  selector: 'lexus-delivery-order-modal',
  templateUrl: './lexus-delivery-order-modal.component.html',
  styleUrls: ['./lexus-delivery-order-modal.component.scss']
})
export class LexusDeliveryOrderModalComponent implements OnInit {
  ...
  constructor(private setModalHeightService: SetModalHeightService,
              private lexusReturnToDealerApi: LexusReturnToDealerApi,
  ...
  returnParts() {
    ...
    this.lexusReturnToDealerApi.return({
      order: Object.assign({}, this.invoice, this.searchForm.value),
      parts: this.partsList
    }).subscribe(() => {
      this.loadingService.setDisplay(false);
      this.swalAlertService.openSuccessToast('Trả thành công');
      this.downloadReport();
    });
  }
