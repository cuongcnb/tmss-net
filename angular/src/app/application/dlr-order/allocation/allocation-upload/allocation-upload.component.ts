...
@Component({
  selector: 'allocation-upload',
  templateUrl: './allocation-upload.component.html',
  styleUrls: ['./allocation-upload.component.scss']
})
export class AllocationUploadComponent implements OnInit {
  ...
  uploadFile() {
    ...
    this.importService.uploadDlrAllocation(this.uploader, this.dealerId, this.currentDate);
