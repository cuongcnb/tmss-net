...
@Component({
  selector: 'sales-order-upload',
  templateUrl: './sales-order-upload.component.html',
  styleUrls: ['./sales-order-upload.component.scss']
})
export class SalesOrderUploadComponent implements OnInit {
  ...
  uploadFile() {
    ...
    this.importService.uploadDlrSalesOrder(this.uploader, this.dealerId, this.currentDate);
