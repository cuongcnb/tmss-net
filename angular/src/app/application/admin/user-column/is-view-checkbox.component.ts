...
export class IsViewCheckboxComponent implements AgRendererComponent {
  params: any;
  ...
  refresh(params: any) {
    params.data.isView = params.value;
    this.updateCheckboxUserColumnService.setParamsData(params.data);
    this.updateCheckboxUserColumnService.isViewChange(params.value);
