...
@Component({
  ...
  selector: 'list-parts-errors',
  templateUrl: './list-parts-errors.component.html',
  styleUrls: ['./list-parts-errors.component.scss'],
})
export class ListPartsErrorsComponent implements OnInit {
  @ViewChild('newPartModal', {static: false}) newPartModal;
  gridParams;
  fieldGrid;
  ...
  editRow() {
    if (this.selectedRowGrid) {
      this.newPartModal.open(this.selectedRowGrid);
    } else {
