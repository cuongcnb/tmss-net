...
@Component({
  ...
  selector: 'work-plan-proposal',
  templateUrl: './work-plan-proposal.component.html',
  styleUrls: ['./work-plan-proposal.component.scss']
})
export class WorkPlanProposalComponent implements AfterViewInit, OnInit, OnChanges {
  ...
  cancelSuggest() {
    this.roWshopApi.cancelSuggest(this.form.value.roId, false).subscribe(res => {
