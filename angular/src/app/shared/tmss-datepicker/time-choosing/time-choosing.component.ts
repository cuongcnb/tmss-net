...
@Component({
  ...
  selector: 'time-choosing',
  templateUrl: './time-choosing.component.html',
  styleUrls: ['./time-choosing.component.scss']
})
export class TimeChoosingComponent implements AfterViewInit {
